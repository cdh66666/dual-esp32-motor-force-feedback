...
def main() -> int:
    ...
    parser.add_argument("--max-velocity", type=float, default=1200.0)
    parser.add_argument("--deadband", type=float, default=3.0)
    parser.add_argument("--min-velocity", type=float, default=150.0)
    parser.add_argument("--targets", type=float, nargs="+", default=[360.0, 0.0, -360.0, 0.0])
    ...
    parser.add_argument("--velocity-kp", type=float, default=0.0015)
    parser.add_argument("--velocity-ki", type=float, default=0.0005)
    parser.add_argument("--velocity-max-current", type=float, default=3.0)
    parser.add_argument("--velocity-friction", type=float, default=0.65)
    parser.add_argument("--velocity-current-slew", type=float, default=3.0)
    parser.add_argument("--velocity-brake-slew", type=float, default=4.0)
    parser.add_argument("--position-acceleration", type=float, default=1600.0)
