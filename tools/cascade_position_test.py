...
def main() -> int:
    ...
    parser.add_argument("--min-velocity", type=float, default=1200.0)
    ...
    parser.add_argument("--velocity-ki", type=float, default=0.0002)
    parser.add_argument("--velocity-max-current", type=float, default=3.0)
    parser.add_argument("--velocity-friction", type=float, default=2.0)
    parser.add_argument("--velocity-current-slew", type=float, default=6.0)
    parser.add_argument("--velocity-brake-slew", type=float, default=20.0)
    parser.add_argument("--position-acceleration", type=float, default=6000.0)
