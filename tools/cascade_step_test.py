...
def main() -> int:
    ...
    parser.add_argument("--ki", type=float, default=0.0002)
    ...
    parser.add_argument("--current-slew", type=float, default=6.0)
    parser.add_argument("--brake-slew", type=float, default=20.0)
